...
unless ContextMenusController.included_modules.include?(RedmineFavoriteProjects::Patches::ContextMenusControllerPatch)
  ContextMenusController.send(:include, RedmineFavoriteProjects::Patches::ContextMenusControllerPatch)
end